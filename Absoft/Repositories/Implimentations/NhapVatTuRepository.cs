    ...
    public class NhapVatTuRepository : INhapVatTuRepository
    {
        ...
        public async Task<PagedList<NhapVatTuViewModel>> GetAllPagingAsync(PagingParams pagingParams)
        {
            ...
            if (!string.IsNullOrEmpty(pagingParams.Keyword))
            {
                ...
                query = query.Where(x => x.MaPhieuNhap.ToString().Contains(keyword) ||
            ...
            if (!string.IsNullOrEmpty(pagingParams.SearchValue))
            {
                ...
                if (pagingParams.SearchKey == "tenHM")
                    query = query.Where(x => x.TenHM == pagingParams.SearchValue.Trim());
        ...
        public async Task<bool> SumTongLuongTongTien(int id)
        {
            ...
            {
                tongluong += item.SoLuong.Value;
                tongtien += (item.SoLuong.Value * item.DonGia.Value);
            }
